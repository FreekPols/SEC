...
of, via een jupyter-environment:
```{eval-rst}
.. retrolite:: notebook_assignments/assignment1_1.ipynb
   :width: 100%
   :height: 400px
   :prompt: assignment 1
```
...
of, via een jupyter-environment:
```{eval-rst}
.. retrolite:: notebook_assignments/assignment1_2.ipynb
   :width: 100%
   :height: 400px
   :prompt: assignment 2-4
```
